...
const cafePerks = [
  "Pravidelné dodávky čerstvé kávy",
  "Baristická školení a support",
  "Poradenství s technologiemi",
  "Velkoobchodní ceník",
]
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="bg-[#faf6f1] rounded-xl p-8 lg:p-12 border border-black relative overflow-hidden group flex flex-col h-full">
            <div className="absolute -right-8 -bottom-8 lg:-right-4 lg:-bottom-12 w-64 h-64 lg:w-96 lg:h-96 opacity-100 transition-transform duration-500 group-hover:scale-105 pointer-events-none">
              <Image
                ...
                alt="Coffee for Cafes Illustration"
                fill
            ...
            <div className="relative z-10 flex-1 flex flex-col">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-pink font-mono text-sm tracking-wider uppercase font-bold">Velkoobchod</span>
              </div>
              <h3 className="text-3xl lg:text-4xl font-bold text-black mb-4 uppercase">Kafe do kaváren</h3>
              <p className="text-black/80 text-lg mb-8 max-w-md">
                Výběrová káva, která nadchne vaše hosty. Kompletní servis, školení baristů a vybavení pro vaši kavárnu.
              </p>
              <ul className="space-y-4 mb-8">
                {cafePerks.map((perk, idx) => (
        ...
        <div className="bg-[#faf6f1] rounded-xl p-4 sm:p-6 lg:p-8 border border-black flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
          ...
          <div className="z-10 w-full md:w-auto flex justify-center md:block">
            <Button
              className="bg-[#2d7d4f] text-[#faf6f1] hover:bg-[#2d7d4f] rounded-none font-bold px-8 py-6 transition-colors w-full md:w-auto"
            >
              Více o doručení
            </Button>
          </div>
